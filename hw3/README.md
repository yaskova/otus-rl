...
* Агент, обученный на 300 эпизодах, сохранен в файле [actor.pt](./actor.pt)
* Дополнительно была реализована визуализация работы агента в виде анимации gif.

### Визуализация
Визуализация работы агента, обученного на 300 эпизодах:

![graph-hw3.png](./graph-hw3.png)
![car_racing.gif](./car_racing.gif)

При текущих гиперпараметрах и на небольшом количестве эпизодов агент не справляется с задачей, однако по графику средней награды видно, что происходит рост по мере обучения. Это подтверждает обучаемость агента в ручной реализации на Torch.
